...
import zaahaAmbianceImg from '../assets/zaaha_about_real_ambiance_1786103765454.png';
  ...
  return (
    <section id="about" style={{ background: '#0C0806', color: '#FAF6F0', padding: '100px 24px', position: 'relative' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '60px', alignItems: 'center' }}>
        ...
        <div>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(212, 175, 55, 0.12)', border: '1px solid rgba(212, 175, 55, 0.3)', padding: '6px 16px', borderRadius: '9999px', color: '#D4AF37', fontSize: '12px', fontWeight: 800, letterSpacing: '1.5px', textTransform: 'uppercase', marginBottom: '20px' }}>
            <Sparkles size={14} />
          ...
          <h2 className="font-heading" style={{ fontSize: 'clamp(32px, 4vw, 50px)', fontWeight: 700, lineHeight: 1.2, marginBottom: '24px' }}>
            A Journey of <span style={{ color: '#D4AF37' }}>Flavor, Passion</span>, and Excellence
          </h2>
          ...
          {/* Quick Stats Grid */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', paddingTop: '24px', borderTop: '1px solid rgba(212, 175, 55, 0.2)' }}>
            <div>
              <div style={{ fontSize: '28px', fontWeight: 800, color: '#D4AF37' }}>2021</div>
              <div style={{ fontSize: '12px', color: '#CBBFB4', fontWeight: 600 }}>Established</div>
            </div>
            <div>
              <div style={{ fontSize: '28px', fontWeight: 800, color: '#D4AF37' }}>3 Outlets</div>
              <div style={{ fontSize: '12px', color: '#CBBFB4', fontWeight: 600 }}>Ernakulam & Infopark</div>
            </div>
            <div>
              <div style={{ fontSize: '28px', fontWeight: 800, color: '#D4AF37' }}>100k+</div>
        ...
        <div style={{ position: 'relative' }}>
          <div style={{
            ...
            <img 
              src={zaahaAmbianceImg} 
              alt="Zaaha Kitchen Ambiance" 
            ...
            <div style={{ position: 'absolute', bottom: '24px', left: '24px', right: '24px', backdropFilter: 'blur(16px)', background: 'rgba(18, 12, 7, 0.82)', border: '1px solid rgba(212, 175, 55, 0.3)', padding: '20px', borderRadius: '18px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <Star color="#D4AF37" fill="#D4AF37" size={24} />
                <div>
